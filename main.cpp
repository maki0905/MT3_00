...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		Vector3 a = Subtract(screenVertices[1], screenVertices[0]);
		Vector3 b = Subtract(screenVertices[2], screenVertices[1]);
		Vector3 cross_ad = Cross(a, b);

		float dirctionDecision = Dot(Vector3(0.0f, 0.0f, 1.0f), cross_ad);
